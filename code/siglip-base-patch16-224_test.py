...
RUN_NAME = 'siglip-base-patch16-224' #
...
WEIGHT_PATH = '/mnt/public/***/***/LOVR/models/siglip-base-patch16-224' #
...
def load_model():
    ...
    model = AutoModel.from_pretrained(
        ...
        attn_implementation="sdpa"  # 和例程一致
    )
    ...
    for video in pbar:
        ...
        with _timer("preprocess_cost"):
            ...
            for frame_list in images:
                ...
                video_inputs = processor(images = pil_imgs, return_tensors='pt', padding = True)
